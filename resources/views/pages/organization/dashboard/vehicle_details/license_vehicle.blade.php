                    ...
                    <div class="p-4 rounded-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center mt-5">
                                <a href="{{ route('dashboard.makeVehicleLicense', $result) }}" class="btn btn-primary">License Vehicle</a>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="p-4 rounded-4">
                        ...
                        <div class="col-md-12 text-center mt-5">
                            <a href="{{ route('dashboard.licenseVehicle') }}" class="btn btn-primary">Go to Back</a>
                        </div>
                    </div>
                @endif
            @endif
