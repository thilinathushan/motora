        ...
        <div class="card-body p-4">
            ...
            @if (!$result)
                <div class="p-4 rounded-4">
                    <form action="{{ route('dashboard.vehicle.findUserVehicle') }}" method="post" autocomplete="true"
                        ...
                        <button type="submit" class="btn w-100 mt-4 btn-primary">Find My Vehicle</button>
                    </form>
                </div>
            @else
                    ...
                    <div class="p-4 rounded-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center mt-5">
                                <a href="{{ route('dashboard.claimUserVehicle', $result) }}" class="btn btn-primary">Claim
                                    Your Vehicle</a>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="p-4 rounded-4">
                        ...
                        <div class="col-md-12 text-center mt-5">
                            <a href="{{ route('dashboard.addVehicleDetails') }}" class="btn btn-primary">Add Your Vehicle
                            </a>
                        </div>
                    </div>
                @endif
