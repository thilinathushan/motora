    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Let's Add Vehicle Insurance Details 👋</p>
            </div>
            @if (!$result)
                    ...
                    <div class="p-4 rounded-4">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center mt-5">
                                ...
                                <a href="{{ route('dashboard.addVehicleInsurance', $result) }}" class="btn btn-primary">Add Vehicle Insurance Records</a>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="p-4 rounded-4">
                        ...
                        <div class="col-md-12 text-center mt-5">
                            <a href="{{ route('dashboard.vehicleInsurance') }}" class="btn btn-primary">Go to Back</a>
                        </div>
                    </div>
                @endif
            @endif
