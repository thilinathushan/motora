        ...
        <div class="card-body p-4">
            ...
            <div class="p-4 rounded-4" style="background-color: #fdeff4">
                <form action="
                    ...
                    @elseif($verifyVehicle && isset($notification_id))
                        {{ route('dashboard.vehicle.verifyVehicleRegistrationDetails', $notification_id) }}
                    @else
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="registration_number" name="registration_number"
                               ...
                               @if ($verifyVehicle) readonly @endif>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" id="current_owner_address_idNo" name="current_owner_address_idNo" rows="3" @if ($verifyVehicle) readonly @endif>@if(!$vehicle_details_add){{ $vehicle_details->current_owner_address_idNo }}@endif</textarea>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" id="absolute_owner" name="absolute_owner" rows="3" @if ($verifyVehicle) readonly @endif>@if(!$vehicle_details_add){{ $vehicle_details->absolute_owner }}@endif</textarea>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="cylinder_capacity" name="cylinder_capacity" value="@if(!$vehicle_details_add){{ $vehicle_details->cylinder_capacity }}@endif"
                                required @if ($verifyVehicle) readonly @endif>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <textarea class="form-control" id="previous_owners" name="previous_owners" rows="10" @if ($verifyVehicle) readonly @endif>@if(!$vehicle_details_add)@foreach (json_decode($vehicle_details['previous_owners']) as $owner)@if(!$loop->first){{ "\n\n" }}@endif{{ $owner }}@endforeach @endif</textarea>
