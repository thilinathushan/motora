...
<div class="offcanvas offcanvas-end" tabindex="-1" id="theme-settings-offcanvas">
    ...
    <div class="offcanvas-body p-3 h-100" data-simplebar>
        ...
        <div>
            ...
            <div class="d-flex gap-2">
                <div class="form-check form-radio w-50">
                    <input class="form-check-input" type="radio" name="data-sidenav-color" id="leftbar-color-light"
                        value="light">
                    <label class="form-check-label" for="leftbar-color-light">Light</label>
                </div>

                <div class="form-check form-radio w-50">
                    <input class="form-check-input" type="radio" name="data-sidenav-color" id="leftbar-color-dark"
                        value="dark">
                    <label class="form-check-label" for="leftbar-color-dark">Dark</label>
                </div>
                <div class="form-check form-radio w-50">
                    <input class="form-check-input" type="radio" name="data-sidenav-color" id="leftbar-color-brand"
                        value="brand">
